...
No pip installs are needed. Run `python -m onboarding.server` and open http://127.0.0.1:8000. Stop with Ctrl+C.
...
Use Python 3.10 or newer from the repository root. No packages need installing.
